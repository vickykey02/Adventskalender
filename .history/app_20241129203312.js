...
function showContent(content, dateString) {
	...
	/*modal.style.position = 'fixed';//ab hier
	modal.style.top = '0';
	modal.style.left = '50%'; //neuer try
	modal.style.transform = 'translateX(-50%)'; // Center the modal horizontally neuer try
	modal.style.width = '100%';
	modal.style.height = '100%';
	modal.style.backgroundColor = 'rgba(0, 0, 0, 0.8)';
	modal.style.display = 'flex';
	modal.style.justifyContent = 'center';
	modal.style.alignItems = 'center';//bis hier
