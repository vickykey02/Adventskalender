...
function showContent(content, dateString) {
	...
	closeButton.textContent.backgroundColor = 'white';
	//closeText.classList.add('button::before');
	//closeText.textContent = 'Close';
	//closeButton.textContent = 'zurück';
	closeButton.style.zIndex = '2001'; // Schrift eine Ebene nach vorn schieben
	...
	if (currentDate7.getTime() === targetDate7.getTime()) {
		...
		//linkButton7.innerHTML.zIndex = '1001';
	...
	if (currentDate19.getTime() === targetDate19.getTime()) {
		...
		//linkButton7.innerHTML = `<p>zum Lesestoff</p>`; // Text als separates HTML-Element
		//linkButton7.innerHTML.zIndex = '1001';
		linkButton19.textContent = 'zum Lesestoff';
